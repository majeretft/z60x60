$(function () {
	var removeVerticalCarousel = function () {
		if (!!navigator.userAgent.match(/ipod|ipad|iphone.*Version\/[\d\.]+.*Safari/i)) {
			$('.carousel.vertical').removeClass('vertical');
		}
	}
	...
	var getLogo = function () {
		...
		$('img.logo-ami').attr('src', isWinter ? 'img/logo.gif' : 'img/logo2.gif')
	}
